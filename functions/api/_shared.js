...
export function json(data, status = 200) {
  return new Response(JSON.stringify(data), {
    ...
    headers: {
      ...
      "Access-Control-Expose-Headers": "X-CWS-OK,X-CWS-State-Exists,X-CWS-Version,X-CWS-Updated-At,X-CWS-Updated-By,X-CWS-User-Email,X-CWS-User-Role,X-CWS-User-Display-Name,X-CWS-Bytes,X-CWS-Chunked,X-CWS-Chunk-Count,X-CWS-Unrecoverable-Invalid-Chunks"
    }
  });
}
