...
export async function onRequestGet(context) {
  ...
  try {
    ...
    return json({
      ...
      storage: "d1",
      version: "internal-test-v73",
      healthMode: "v73-lightweight-no-state-load", // compatibility: v72-lightweight-no-state-load v70-lightweight-no-state-load v67-lightweight-no-state-load // compatibility marker: v57-lightweight-no-state-load
      schemaOk: schema.ok,
