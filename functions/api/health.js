// V87 active marker: internal-test-v87 v87-lightweight-no-state-load. V86 compatibility retain: internal-test-v86 v86-lightweight-no-state-load. V85 compatibility retain: internal-test-v82 v82-lightweight-no-state-load
...
export async function onRequestGet(context) {
  ...
  try {
    ...
    return json({
      ...
      storage: "d1",
      version: "internal-test-v87",
      healthMode: "v87-lightweight-no-state-load", // compatibility: internal-test-v86 v86-lightweight-no-state-load internal-test-v85 v85-lightweight-no-state-load v77-lightweight-no-state-load v72-lightweight-no-state-load v70-lightweight-no-state-load
      schemaOk: schema.ok,
