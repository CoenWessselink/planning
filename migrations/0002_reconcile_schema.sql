-- Alleen gebruiken in de interne testomgeving zolang er nog geen echte data in D1 staat.
-- Dit script trekt een eerder fout/handmatig schema gelijk met de applicatiecode.
