...
check('V60 state GET ondersteunt raw/chunked response zonder JSON wrapper', stateApi.includes('wantsRawStateResponse') && stateApi.includes('readFullStateJson') && stateApi.includes('rawStateResponse(fullStateJson || ""') && stateApi.includes('X-CWS-State-Exists') && stateApi.includes('X-CWS-Version'));
