...
check('V59/V65 Gantt corrigeert/deriveert bestaande planning veilig', (gantt.includes('normalizeModelSchedulesForWorkdays') || gantt.includes('effectiveScheduleMap')) && (gantt.includes('taakdatum(s) naar werkbare dagen gecorrigeerd') || gantt.includes('renderen zelf\n       schrijft nooit automatisch naar D1')));
