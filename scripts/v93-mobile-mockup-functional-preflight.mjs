...
ok("Mobiel iframe krijgt nav-veilige flexhoogte", css.includes(".app-shell") && css.includes("var(--cws-mobile-nav-h)") && css.includes("display:flex!important;flex-direction:column!important") && css.includes("#appFrame{width:100%!important;height:100%!important"));
