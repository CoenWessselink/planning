...
check("V59 Gantt plant uitsluitend op werkbare dagen", read("js/core/store.js").includes("normalizeGanttModelSchedules(draft, deepClone(model))") && read("js/core/store.js").includes("v59-working-days-only") && read("layers/laag4_gantt.html").includes("function workSegments") && (read("layers/laag4_gantt.html").includes("bar-segment") || read("layers/laag4_gantt.html").includes("bar-workday-shell") || read("layers/laag4_gantt.html").includes("bar-continuous-task")) && read("layers/laag4_gantt.html").includes("Balk bijgewerkt op werkbare dagen") && fs.readFileSync("package.json", "utf8").includes('"preflight:v59"'));
if(process.exitCode) process.exit(process.exitCode);
