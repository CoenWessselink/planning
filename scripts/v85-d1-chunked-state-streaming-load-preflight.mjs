...
assert(stateApi.includes("v85-d1-chunked-state-streaming-load-fix"), "state.js mist V85 marker.");
...
assert(stateApi.includes("migrateOversizedInlineStateToChunks"), "state.js mist inline-to-chunks migratie.");
