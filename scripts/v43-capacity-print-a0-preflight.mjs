...
const printView=f("layers/capacity_print_view.html");
...
const checks=[
 ...
 ["Capaciteit gebruikt dedicated printpagina",()=>capacityPrint.includes("/layers/capacity_print_view.html")&&capacityPrint.includes("postMessage(payload, targetOrigin)")&&printView.includes("CWS_CAPACITY_TASCHE_A3_PRINT_V161")&&printView.includes("window.print()")],
