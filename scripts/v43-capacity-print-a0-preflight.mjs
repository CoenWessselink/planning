...
const checks=[
 ...
 ["Uniform dun raster rondom tabel/week/dag/afdeling",()=>capacityPrint.includes("border:0.35pt solid #9ca3af")&&capacityPrint.includes("capacity-table")],
 ...
 ["PDF/documenttitel via nieuwe capaciteit-renderer",()=>capacityPrint.includes("<title>CAPACITEITSOVERZICHT</title>")&&capacityPrint.includes("PRINT_WINDOW_NAME")&&capacityPrint.includes("CWS_CAPACITY_TASCHE_A3_PRINT_V161")&&capacityPrint.includes("printCurrentDocument")&&cap.includes("capacityTaschePrint")],
 ["Capaciteit gebruikt hidden iframe zonder printpagina/popup",()=>capacityPrint.includes('document.createElement("iframe")')&&capacityPrint.includes("contentWindow.print()")&&!capacityPrint.includes("/layers/capacity_print_view.html")&&!capacityPrint.includes("postMessage(payload, targetOrigin)")&&!capacityPrint.includes("window.open")],
