...
const checks=[
 ...
 ["PDF/documenttitel via nieuwe capaciteit-renderer",()=>capacityPrint.includes("<title>CAPACITEITSOVERZICHT</title>")&&capacityPrint.includes("doc.write(printHtml)")&&capacityPrint.includes("CWS_CAPACITY_TASCHE_A3_PRINT_V155")&&capacityPrint.includes("printCurrentDocument")&&cap.includes("capacityTaschePrint")],
