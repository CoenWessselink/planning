...
const checks=[
 ...
 ["PDF/documenttitel via nieuwe capaciteit-renderer",()=>capacityPrint.includes("<title>CAPACITEITSOVERZICHT</title>")&&capacityPrint.includes("PRINT_WINDOW_NAME")&&capacityPrint.includes("CWS_CAPACITY_TASCHE_A3_PRINT_V157")&&capacityPrint.includes("printCurrentDocument")&&cap.includes("capacityTaschePrint")],
 ["Capaciteit gebruikt dedicated printpagina",()=>capacityPrint.includes("/layers/capacity_print_view.html")&&capacityPrint.includes("PRINT_STORAGE_PREFIX")&&printView.includes("CWS_CAPACITY_TASCHE_A3_PRINT_V157")&&printView.includes("window.print()")],
