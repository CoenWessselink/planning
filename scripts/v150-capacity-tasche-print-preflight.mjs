...
add("Index laadt nieuwe printmodule met cachebust", index.includes("js/core/capacity_print_tasche_a3.js?v=154"));
add("Capaciteit-laag laadt printmodule direct in eigen document", cap.includes('../js/core/capacity_print_tasche_a3.js?v=154'));
...
add("Module heeft eigen capaciteit-printroot, frame en marker", mod.includes("CWS_CAPACITY_TASCHE_A3_PRINT_V154") && mod.includes("cwsCapacityTaschePrintFrame") && mod.includes("cwsCapacityPrintRoot") && mod.includes('data-cws-print-kind="capacity-overview"'));
...
add("Current-document printroot aanwezig", mod.includes("function printCurrentDocument") && mod.includes("installCurrentDocumentPrintRoot(printHtml)") && mod.includes("body > :not(#${ROOT_ID})"));
