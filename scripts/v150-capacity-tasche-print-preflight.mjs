...
add("Index laadt nieuwe printmodule met cachebust", index.includes("js/core/capacity_print_tasche_a3.js?v=160"));
add("Capaciteit-laag laadt printmodule direct in eigen document", cap.includes('../js/core/capacity_print_tasche_a3.js?v=160'));
...
add("Module heeft eigen capaciteit-printroot en marker", mod.includes("CWS_CAPACITY_TASCHE_A3_PRINT_V160") && mod.includes("cwsCapacityPrintRoot") && mod.includes('data-cws-print-kind="capacity-overview"'));
...
add("Dedicated printpagina bevat alleen capaciteitsoverzicht", printView.includes("CWS_CAPACITY_TASCHE_A3_PRINT_V160") && printView.includes("CAPACITEITSOVERZICHT") && printView.includes("localStorage.getItem") && printView.includes("window.print()") && !/CWS_BWS_A3_PRINT_FINAL|data-bws-marker|Bouwplanning/.test(printView));
