...
add("Index laadt nieuwe printmodule met cachebust", index.includes("js/core/capacity_print_tasche_a3.js?v=156"));
add("Capaciteit-laag laadt printmodule direct in eigen document", cap.includes('../js/core/capacity_print_tasche_a3.js?v=156'));
...
add("Module heeft eigen capaciteit-printroot en marker", mod.includes("CWS_CAPACITY_TASCHE_A3_PRINT_V156") && mod.includes("cwsCapacityPrintRoot") && mod.includes('data-cws-print-kind="capacity-overview"'));
...
add("Capaciteit print via top-level printvenster", mod.includes("window.top") && mod.includes(".open(\"\", PRINT_WINDOW_NAME)") && mod.includes("cws_capacity_overview_print"));
