...
add("Index laadt nieuwe printmodule met cachebust", index.includes("js/core/capacity_print_tasche_a3.js?v=155"));
add("Capaciteit-laag laadt printmodule direct in eigen document", cap.includes('../js/core/capacity_print_tasche_a3.js?v=155'));
...
add("Module heeft eigen capaciteit-printroot, frame en marker", mod.includes("CWS_CAPACITY_TASCHE_A3_PRINT_V155") && mod.includes("cwsCapacityTaschePrintFrame") && mod.includes("cwsCapacityPrintRoot") && mod.includes('data-cws-print-kind="capacity-overview"'));
