// V87 active marker: local-test-v87 local-test-server-v87. V86 compatibility retain: local-test-v86 local-test-server-v86. V85 compatibility retain: local-test-v82 local-test-server-v82
// V82 local marker: local-test-v85 local-test-server-v85
// compatibility marker: local-test-v73; V76 active marker: local-test-v76; V77 active marker: local-test-v77 local-test-server-v77; V78 active marker: local-test-v85
  ...
  try {
    ...
    if (pathname === "/api/health") {
      ...
      res.end(JSON.stringify({
        ...
        storage: "local",
        version,
        healthMode: "local-test-server-v87",
        schemaOk: true,
        schemaErrors: [],
