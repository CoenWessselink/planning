// V86 active marker: local-test-v86 local-test-server-v86. V85 compatibility retain: local-test-v82 local-test-server-v82
  ...
  try {
    ...
    if (pathname === "/api/health") {
      ...
      res.end(JSON.stringify({
        ...
        storage: "local",
        version,
        healthMode: "local-test-server-v86",
        schemaOk: true,
        schemaErrors: [],
